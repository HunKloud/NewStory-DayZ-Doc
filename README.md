...
+ __MinQuantity__ - Минимальное значение кол-ва
    ...
    >
    > 1. В процентном соотношении от максимального значения (т.е. от 0 до 1) :heavy_exclamation_mark: Итоговое значение будет браться от первого предмета в списке __Type__
...
+ __MaxQuantity__ - Максимальное значение кол-ва
    ...
    >
    > :heavy_exclamation_mark: Итоговое значение должно быть больше __MinQuantity__
...
1. __Крафт__ ( CategoryID = 0 )
2. __Разбор__ ( CategoryID = 1 )
3. __Ремонт__ ( CategoryID = 2 )
